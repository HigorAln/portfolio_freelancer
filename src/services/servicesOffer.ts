...
export const servicesOfferVariables: IServeicesOffer[] = [
  {
    id: 1,
    title: 'Ladding Page',
    description: 'Criação de ladding pages incriveis para sua empresa, para seu negócio, ou para seu uso pessoal.',
    Icon: AiFillLayout,
    active: true,
  },
  {
    id: 2,
    title: "E-commerce",
    description: "Criação de lojas virtuais para sua empresa, para seu negócio, ou para seu uso pessoal.",
    Icon: BiShoppingBag,
    active: false,
  },
  {
  ...
  },
  {
    ...
    description: "I create beautiful iterfaces with simple HTML, CSS, & JavaScript and also frameworks like ReactJS",
    active: true,
    Icon: RiComputerLine
  },
  {
